...
const SimliAgent: React.FC<SimliAgentProps> = ({ onStart, onClose }) => {
  ...
  const handleJoinRoom = async () => {
    ...
    /**********************************/
    const response = await fetch("https://api.simli.ai/session/0e0edc45-7d54-4ccf-a245-848fbf13eee3/gAAAAABoeKu4LjhNsLz-KRIUxoBRNIWeEu5Hiw8sp_TLyUsNvgDIRXr_wZyGncklpGZogtA4CvGhZ3Ho6DnjnlnyocfXI8kCHLdwhdKhUU2rNWwdXQC6e4XMvBh71Ha_M-qMndKRYNrOMNM6X7UgA9xBPNAd_osK-FORyZNr_3zE4K1UxOGrneDJVRV7Q-7GS1X-f-y7W9DxPndKCgNs8XwN1H93v75aR7rcoTr-_2tdljkAcVtYe7VFomGrNQvGzm_or-ah2b3hq7hsfzV74krBbs-ODyk3fUk5IOnqCPcUtoQQNb7YJgT_4_Fl2lbNvX1UsdToBr3EiDdR4FL1Ci92UF53m3JaDu2b0Scudt7WtuxvDhbri5CVHFzInwLF1yplCXh-tdEOvG-iJ-NdflTqVMZTxnG-Sw==", {
        method: "GET",
        headers: {
